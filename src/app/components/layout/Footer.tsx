        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-300">
              Helping brands rise above the noise and connect meaningfully with their audience through innovative marketing solutions.
            </p>
          ...
          <div>
            ...
            <ul role="list" className="mt-4 space-y-3">
              <li className="flex">
                <MapPinIcon className="h-6 w-6 text-blue-400 mr-3 flex-shrink-0" />
              ...
              <li className="flex">
                ...
                <a href="tel:+14155550123" className="text-gray-300 hover:text-white">+1 (415) 555-0123</a>
              </li>
              <li className="flex">
                <EnvelopeIcon className="h-5 w-5 text-blue-400 mr-3 mt-1 flex-shrink-0" />
                <a href="mailto:hello@elevare.com" className="text-gray-300 hover:text-white">hello@elevare.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <div className="md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; {new Date().getFullYear()} Elevare Marketing Agency. All rights reserved.
            </p>
          </div>
        </div>
      </div>
